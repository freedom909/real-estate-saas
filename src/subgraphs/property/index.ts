...
import {resolvers} from "./resolvers/property.resolver"

import registerPropertyDependencies from "./container/registerPropertyDependencies"
...
console.log("Property container loaded")//good
...
// ⭐ schema
const typeDefs = gql(
  readFileSync("./src/subgraphs/property/property.schema.graphql", "utf-8")
)
...
httpServer.listen(4050, () => {
  console.log("🔐 Property subgraph running at http://localhost:4050/graphql")
})