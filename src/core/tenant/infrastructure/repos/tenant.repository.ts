//src/core/tenant/infrastructure/repos/tenant.repository.ts
...
} from "../../domain/repos/i-tenant.repository";
import {
  Tenant,
  TenantStatus,
...
{
  constructor(
    @inject(TOKENS_TENANT.models.tenant)
