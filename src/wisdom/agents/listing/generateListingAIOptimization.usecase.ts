...
import { listingOptimizationPrompt } from "@/wisdom/capabilities/listing/prompt/listing.optimization.prompt";
...
import { ILLMProvider } from "@/wisdom/tools/llm/ILLMProvider";
