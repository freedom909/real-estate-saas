...
import ListingAmenityModel  
from "@/subgraphs/listing/infrastructure/models/listingAmenities.model";

import ListingCategories from "@/subgraphs/listing/infrastructure/models/listingCategories.model";
...
export function registerFacetResolvers() {
  ...
  container.register(
    TOKENS_LISTING.ListingCategoriesModel,
    {
  ...
  container.register(
    TOKENS_LISTING.ListingAmenityModel,
    {
  ...
  // repo
  container.register(
    TOKENS_LISTING.ListingRepository,
    {
  ...
  // ai suggestion
  container.register(
    TOKENS_AI.ListingAISuggestionRepository,
    {
  ...
  container.register(
    TOKENS_AI.ListingAISuggestionModel,
    {
  ...
  // use case
  container.register(
    TOKENS_AI.usecase.generateTitleSuggestionUseCase,
    {
      useClass:
  ...
  // facet resolvers
  container.register(
    TOKENS_FACET_RESOLVERS.listingFacetResolver,
    {
  ...
  container.register(
    TOKENS_FACET_RESOLVERS.bookingFacetResolver,
    {
  ...
  container.register(
    TOKENS_FACET_RESOLVERS.paymentFacetResolver,
    {
      useClass: PaymentFacetResolver,
    }
  );
}